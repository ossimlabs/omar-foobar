...
*/}}
{{- define "omar-foobar.imagePullSecrets" -}}
  {{/*
  ...
  */}}
  ...
  {{- if .Values.generatedImagePullSecret -}}
    {{- if .Values.generatedImagePullSecret.create -}}
      {{- $secrets = (append $secrets (.Values.generatedImagePullSecret.name | default (include "omar-foobar.fullname" .))) }}
    {{- end -}}
  {{- end -}}
...
{{- define "omar-foobar.generateImagePullSecret" }}
