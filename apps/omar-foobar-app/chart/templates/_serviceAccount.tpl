...
*/}}
{{- define "omar-foobar.serviceAccount.enabled" -}}
...
*/}}
{{- define "omar-foobar.serviceAccount.name" -}}
{{-   if eq (include "omar-foobar.serviceAccount.enabled" $) "true" }}
{{-     pluck "name" .Values.serviceAccount .Values.global.serviceAccount | first | default (include "omar-foobar.fullname" $) -}}
{{-   else }}
